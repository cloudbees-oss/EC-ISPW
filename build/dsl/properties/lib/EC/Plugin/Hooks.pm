...
sub create_assignment_info_report {
    ...
    my $report = $self->plugin->render_template_from_property('/projects/EC-ISPW-2.0.0.8/resources/assignmentInfoReport', $params);
...
sub create_release_info_report {
    ...
    my $report = $self->plugin->render_template_from_property('/projects/EC-ISPW-2.0.0.8/resources/releaseInfoReport', $params);
...
sub create_release_task_generate_listing_report {
    ...
    my $report = $self->plugin->render_template_from_property('/projects/EC-ISPW-2.0.0.8/resources/releaseTaskGenerateListingReport', $params);
...
sub create_set_info_report {
    ...
    my $report = $self->plugin->render_template_from_property('/projects/EC-ISPW-2.0.0.8/resources/setInfoReport', $params);
...
sub create_task_info_report {
    ...
    $params->{type} = $type;
    my $report = $self->plugin->render_template_from_property('/projects/EC-ISPW-2.0.0.8/resources/' . $params->{containerType} . 'TaskInfoReport', $params);
